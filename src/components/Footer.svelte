...
<footer class="footer p-10 bg-base-200 text-base-content">
	...
	<div>
		...
		<a class="link link-hover" href="mailto:hello@hackthefeed.com">Contact</a>
...
>
	<div class="items-center grid-flow-col">
		...
		<p>HackTheFeed Ltd.<br />© {year}. All rights reserved.</p>
	</div>
	<div class="md:place-self-center md:justify-self-end">
		<div class="grid grid-flow-col gap-4">
			<a href="https://twitter.com/@hackthefeed">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
			...
			<a href="https://youtube.com/@hackthefeed">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
			...
			<a href="https://facebook.com/hackthefeed">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
